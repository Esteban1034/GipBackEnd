...
public class ProjectStatusReport implements Serializable {
    ...
    private Integer horasAprobadas;
    ...
    public ProjectStatusReport(Integer id, Empleado empleado, LocalDateTime fechaCreacionPsr, String estado,
            ...
            Integer horasAprobadas, Integer horasEjecutadas, Integer horasReales) {
        this.id = id;
    ...
    public Integer getHorasAprobadas() {
        return horasAprobadas;
    }

    public void setHorasAprobadas(Integer horasAprobadas) {
        this.horasAprobadas = horasAprobadas;
    }
