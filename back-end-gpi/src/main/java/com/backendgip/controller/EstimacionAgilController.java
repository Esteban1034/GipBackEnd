...
import com.backendgip.model.EstimacionContenidoAgil;
...
public class EstimacionAgilController {
    ...
    @PutMapping
    public ResponseEntity<?> updateEstimaciones(@RequestBody EstimacionContenidoAgil estimacion) {
        ...
        EstimacionContenidoAgil estimacionesBD = findContenidoEstimacion(estimaciones.getId());
    ...
    public ResponseEntity<?> deleteEstimaciones(@PathVariable Integer id) {
        ...
        List<EstimacionAgil> actividades = estimacionAgilService.findByEstimacion(estimacion);
    ...
    public EstimacionContenidoAgil findContenidoEstimacion(@PathVariable Integer idEstimacion) {
        EstimacionContenidoAgil estimacionContenido = new EstimacionContenidoAgil();
